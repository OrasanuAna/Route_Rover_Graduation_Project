                ...
                <div class="form-container">
                    <form action="reseteaza_parola.php" method="post" class="p-4 rounded">
                        ...
                        <div class="form-group position-relative">
                            ...
                            <i toggle="#parola_noua" class="fas fa-fw fa-eye-slash field-icon toggle-password" style="color: #495057;"></i>
                        </div>
                        <div class="form-group position-relative">
                            <input type="password" class="form-control" id="confirma_parola" name="confirma_parola" placeholder="Confirmă parola">
                            <i toggle="#confirma_parola" class="fas fa-fw fa-eye-slash field-icon toggle-password" style="color: #495057;"></i>
                        </div>
