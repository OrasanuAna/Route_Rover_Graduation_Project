...
try {
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'orasanu.anamaria19@gmail.com'; // SMTP username
    $mail->Password = 'hqxa jnqw dint lrqo '; // SMTP password
    $mail->SMTPSecure = 'tls'; // Enable TLS encryption, ssl also accepted
    $mail->Port = 587; // Port pentru TLS/STARTTLS
    $mail->CharSet = 'UTF-8';

    // Destinatari
    $mail->setFrom('no-reply@route-rover.ro', 'no-reply@route-rover.ro');
